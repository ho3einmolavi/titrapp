...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <form class="form-horizontal" action="{{ route('catsForBlogs.store') }}" method="post"
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="parent_id" style="width: 100%;">
                                        ...
                                        @foreach(\App\CategoryForBlog::orderBy('name')->where('parent_id',0)->get() as $skil)
                                            <option value="{{$skil->id}}" {{old('parent_id') == $skil->id ? 'selected' : ''}}>{{$skil->name}}</option>
                                            @if(\App\CategoryForBlog::where('parent_id',$skil->id)->get()->count() > 0)
                                                @foreach(\App\CategoryForBlog::where('parent_id',$skil->id)->get() as $sub_skil)
