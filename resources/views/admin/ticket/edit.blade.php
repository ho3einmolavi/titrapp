...
@section('title', 'ویرایش دسته بندی پشتیبانی')
...
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-left">
                        ...
                        <li class="breadcrumb-item active">ویرایش دسته بندی پشتیبانی</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <form class="form-horizontal" action="{{ route('ticketCategory.update',$ticketCategory->id) }}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                {{ method_field('PATCH') }}
